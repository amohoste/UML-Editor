...
public class AggregationArrow extends Arrow {
    ...
    public AggregationArrow(UMLBox from, UMLBox to) {
        super(from , to);

        // Lijn aanmaken met juiste afstand en zorgen dat deze juist staat
        line = new Path();
    ...
    public void move() {
        ...
        line.getElements().add(new LineTo(x1, y1 - super.getLength() + 40));
        ...
        head.getPoints().setAll(x2, y2, x2 + 10, y2 + 20, x2, y2 + 40, x2 - 10, y2 + 20);
